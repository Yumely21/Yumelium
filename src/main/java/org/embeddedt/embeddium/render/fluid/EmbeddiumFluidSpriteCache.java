...
/**
 * Resolves the still/flowing/overlay sprites for a fluid. Water and lava reuse vanilla's baked
 * {@link BlockFluidRenderer} sprite arrays (via accessor mixins); other (modded) fluids look up their registered
 * sprite {@link ResourceLocation}s on the block atlas.
 *
 * <p>NOTE(yumelium): ported from Vintagium's {@code org.embeddedt.embeddium.render.fluid.EmbeddiumFluidSpriteCache}.
 */
