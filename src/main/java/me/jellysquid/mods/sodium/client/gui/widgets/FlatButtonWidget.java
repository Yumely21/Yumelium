...
public class FlatButtonWidget extends AbstractWidget implements Drawable {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        int backgroundColor = this.enabled ? (hovered ? 0xE0281E46 : 0x90281E46) : 0x60281E46;
        ...
        if (this.enabled && this.selected) {
            this.drawRect(this.dim.getOriginX(), this.dim.getLimitY() - 1, this.dim.getLimitX(), this.dim.getLimitY(), 0xFFB4A8F0);
        }
    }
