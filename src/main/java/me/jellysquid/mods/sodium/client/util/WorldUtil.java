...
/**
 * 1.12.2 fluid helpers used by {@link me.jellysquid.mods.sodium.client.render.chunk.compile.pipeline.FluidRenderer}.
 *
 * <p>NOTE(yumelium): ported verbatim from Vintagium's {@code common.util.WorldUtil} (which already solved 1.12.2
 * fluids-as-blocks access — {@link BlockLiquid} levels, flow velocity, {@link IFluidBlock} wrappers). Only change:
 * {@code repack.joml.Vector3d} → {@code org.joml.Vector3d}, and it now lives alongside {@link DirectionUtil}.
 */
