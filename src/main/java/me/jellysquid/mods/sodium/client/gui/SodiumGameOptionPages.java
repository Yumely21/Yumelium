    ...
    public static OptionPage nvidium() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("yumelium.options.nvidium_occlusion_culling.name"))
                        .setTooltip(new TextComponentTranslation("yumelium.options.nvidium_occlusion_culling.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.yumeliumPlus.nvidiumOcclusionCulling = value, opts -> opts.yumeliumPlus.nvidiumOcclusionCulling)
                        .setImpact(OptionImpact.HIGH)
                        .build())
                .build());
    ...
    public static OptionPage yumeliumPlus() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("yumelium.options.yumely21_skin.name"))
                        .setTooltip(new TextComponentTranslation("yumelium.options.yumely21_skin.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.yumeliumPlus.yumely21Skin = value, opts -> opts.yumeliumPlus.yumely21Skin)
                        .setImpact(OptionImpact.LOW)
                        .build())
                ...
                .add(OptionImpl.createBuilder(SodiumGameOptions.DynamicLightsMode.class, sodiumOpts)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("yumelium.options.dynamic_lights_shaders.name"))
                        .setTooltip(new TextComponentTranslation("yumelium.options.dynamic_lights_shaders.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.yumeliumPlus.dynamicLightsWithShaders = value, opts -> opts.yumeliumPlus.dynamicLightsWithShaders)
                        .setImpact(OptionImpact.MEDIUM)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("yumelium.options.mod_renderer_cache.name"))
                        .setTooltip(new TextComponentTranslation("yumelium.options.mod_renderer_cache.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.yumeliumPlus.modRendererCache = value, opts -> opts.yumeliumPlus.modRendererCache)
                        .setImpact(OptionImpact.MEDIUM)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
