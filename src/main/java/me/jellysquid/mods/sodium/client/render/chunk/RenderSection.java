...
public class RenderSection {
    ...
    private TileEntity @Nullable[] globalBlockEntities;
    private TileEntity @Nullable[] culledBlockEntities;
     ...
     */
    public TileEntity @Nullable[] getCulledBlockEntities() {
     ...
     */
    public TileEntity @Nullable[] getGlobalBlockEntities() {
    ...
    // delombok: getters for the fields upstream annotated with @Getter
    public @NotNull Map<TerrainRenderPass, TranslucentQuadAnalyzer.SortState> getTranslucencySortStates() {
