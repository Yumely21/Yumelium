...
public class DirectionUtil {
    ...
    // Provides the same order as enumerating EnumFacing and checking the axis of each value
    ...
    private static final EnumFacing[] OPPOSITE_DIRECTIONS = Arrays.stream(ALL_DIRECTIONS)
            .map(EnumFacing::getOpposite)
            .toArray(EnumFacing[]::new);

    // EnumFacing#byId is slow in the absence of Lithium
